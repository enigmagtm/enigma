...
export const Patch = (options?: any): MethodDecorator => {
  const PatchDecorator = (target: Object, property: string | symbol, descriptor: TypedPropertyDescriptor<any>): TypedPropertyDescriptor<any> | void => {
    ...
    if (method) {
      ...
      Reflect.defineProperty(target, name, {
        ...
        value: async function (res: Response, req: Request, next: NextFunction): Promise<void> {
          ...
          await patchConfig.function(this, method, args, { res, req, next, options });
        },
        writable: false
      });
    }
